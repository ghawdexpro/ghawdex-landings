    ...
    <section className="relative section-padding overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-16">
          ...
          >
            <div className="relative h-full min-h-[350px] sm:min-h-[400px] p-6 sm:p-8 md:p-10 overflow-hidden rounded-3xl glass-card hover:shadow-glow transition-all duration-500 transform-gpu hover:scale-[1.02]">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                {/* Content */}
                <div>
                  <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8">
                  <div className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/60 backdrop-blur-sm border border-white/40">
                    <span className="text-xs sm:text-sm font-semibold text-gray-700">⚡ Fast-Track Process</span>
                  </div>
                  <div className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/60 backdrop-blur-sm border border-white/40">
                    <span className="text-xs sm:text-sm font-semibold text-gray-700">✓ Full Turnkey</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative h-full min-h-[160px] sm:min-h-[180px] p-6 sm:p-8 overflow-hidden rounded-3xl glass-card hover:shadow-glow transition-all duration-500 transform-gpu hover:scale-[1.02]">
              <motion.div
              ...
              <div className="relative z-10">
                <div className="inline-flex p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-yellow-500 to-amber-600 mb-3 sm:mb-4 shadow-lg">
          ...
          >
            <div className="relative h-full min-h-[160px] sm:min-h-[180px] p-6 sm:p-8 overflow-hidden rounded-3xl glass-card hover:shadow-glow transition-all duration-500 transform-gpu hover:scale-[1.02]">
              ...
              <div className="relative z-10">
                <div className="inline-flex p-2.5 sm:p-3 rounded-xl bg-gradient-to-r from-red-600 to-orange-600 mb-3 sm:mb-4 shadow-lg">
        ...
        >
          ...
          {/* Glass overlay */}
          <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 p-8 sm:p-10 md:p-14">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
              ...
              <div className="text-center group">
                <AnimatedCounter
                  ...
                  suffix="+"
                  duration={2500}
                  className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300"
                />
                <div className="text-sm sm:text-base md:text-lg text-amber-100 font-medium">Installations Completed</div>
              </div>

              <div className="text-center border-y sm:border-y-0 sm:border-x border-white/30 py-8 sm:py-0 group">
                <AnimatedCounter
                  target={9}
                  duration={1500}
                  className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300"
                />
                <div className="text-sm sm:text-base md:text-lg text-amber-100 font-medium">Days Average Install</div>
              </div>
              ...
              <div className="text-center group">
                <AnimatedCounter
                  ...
                  className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300"
                />
                <div className="text-sm sm:text-base md:text-lg text-amber-100 font-medium">Customer Satisfaction</div>
              </div>
